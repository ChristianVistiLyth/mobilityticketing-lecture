-- Lecture 3, approach 4 of 4: a summary table maintained by a trigger on payments.
-- Kept exactly as supplied: it only reacts to inserts. What that means for
-- corrections, refunds, deletes, backfill and duplicates is recorded in
-- docs/evidence/lecture03/README.md.
