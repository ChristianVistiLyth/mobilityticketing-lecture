...
-- Apply only after the old writers are stopped and lecture04/experiments/verify.sql
-- returns no rows. tickets.product_code stays, and stays NOT NULL, until its
-- removal has been rehearsed with lecture04/experiments/remove_legacy.sql.
